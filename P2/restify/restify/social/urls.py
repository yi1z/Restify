...
urlpatterns = [
    ...
    path('comment/property/<int:target_id>/<order_num>/create/', views.PropertyCommentCreate.as_view(), name='comment-list'),
    ...
    path('reply/<int:target_id>/create/', views.ReplyCommentCreate.as_view(), name='comment-list'),
